...
import {TCheckAndGetTypes} from '../enum/ECommon';
...
export class CommonUtils {
  ...
  static getBlob(docObject: any, type: string = null): Blob {
    try {
      LoggerService.logInfo(this.constructor.name, 'getBlob');
      ...
      LoggerService.logError(this.constructor.name, 'getBlob', e);
    }
  }

  static downloadFile(docObject: any, fileName: string, type: string = null): void {
    try {
      LoggerService.logInfo(this.constructor.name, 'downloadFile');
      let blob = this.getBlob(docObject, type);
      FileSaver.saveAs(blob, fileName);
    } catch (e) {
      LoggerService.logError(this.constructor.name, 'downloadFile', e);
    }
  }
  ...
  static viewFile(docObject: any, fileName: string, type: string = null): void {
    try {
      LoggerService.logInfo(this.constructor.name, 'viewFile');
      ...
      LoggerService.logError(this.constructor.name, 'viewFile', e);
    }
  }
